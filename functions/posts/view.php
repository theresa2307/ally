<html>
    ...
    <body>
        ...
        while ($zeile=$query->fetchObject()){ //alles was in der db steht, alle post werden ausgelesen, was oben gesucht wird bei query
            ...
            echo "<div class='post_body_title'><b>$zeile->titel</b><br></div>"; //titel, nutzername wird angezeigt und nutzername wird verlinkt auf profil

			if (strlen($zeile->datei)>1) { //bild vom post wird ausgelesen
                echo "<div class='post_body_pic'><img src='./functions/posts/uploads/files/$zeile->datei'/></div><br>";
            }
			
            echo "<div class='post_body_text'>$zeile->text</div><br></div>"; // text vom post wird ausgelesen
