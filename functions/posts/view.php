<html>
    ...
    <body>
        ...
        while ($zeile=$query->fetchObject()){ //alles was in der db steht, alle post werden ausgelesen, was oben gesucht wird bei query
            echo "<span><b>$zeile->titel</b> (by <a href='?page=profile&user=$zeile->username'>$zeile->username</a>)</span><br>"; //titel, nutzername wird angezeigt und nutzername wird verlinkt auf profil
            ...
            echo "<div id='post_text'>$zeile->text</div><br><br>"; // text vom post wird ausgelesen
        }
        ?>
    </body>
</html>
